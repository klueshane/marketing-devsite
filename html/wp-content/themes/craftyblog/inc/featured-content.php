<?php
/**
 * Enlighten Featured Content borrowed from Twenty Fourteen
 *
...
class Featured_Content {
	...
	public static function customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'featured-content[tag-name]', array(
			'default'              => _x( 'featured', 'featured content default tag slug', 'enlighten' ),
			'type'                 => 'option',
	...
	public static function get_setting( $key = 'all' ) {
		...
		$defaults = array(
			'hide-tag' => 1,
			'tag-id'   => 0,
			'tag-name' => _x( 'featured', 'featured content default tag slug', 'enlighten' ),
		);
