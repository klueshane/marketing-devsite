...
/*
Custom Meta Boxes
by: https://github.com/humanmade/Custom-Meta-Boxes
...
$cmb_path = get_template_directory() . '/lib/cmb';
$cmb_url = get_template_directory_uri() . '/lib/cmb';
if ( ! defined( 'CMB_DEV') )
	define( 'CMB_DEV', false );

if ( ! defined( 'CMB_PATH') )
	define( 'CMB_PATH', $cmb_path );

if ( ! defined( 'CMB_URL' ) )
	define( 'CMB_URL', $cmb_url );
...
include_once( CMB_PATH . '/maker-meta-boxes.php' );
