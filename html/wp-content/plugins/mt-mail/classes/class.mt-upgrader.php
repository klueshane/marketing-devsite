...
class MT_Mail_Upgrader {
	...
	/**
	 * API communicator
	 * @var MT_Mail_Update_API
	 */
	protected $_api = '';

	/**
	 * Class Constructor
	 * @return MT_Mail_Upgrader
	 */
	public function __construct( $plugin_file = '', $slug = '', $duration = 21600 ) {
	...
	protected function get_api_data() {
		...
		if ( empty( $api_data ) ) {
			...
			set_site_transient( $this->_key . '_api_data', $api_data, $this->_duration );
		}
		return $api_data;
	}
